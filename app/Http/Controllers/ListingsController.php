...
class ListingsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/home')->with('success', 'Listing "' . $listing->name . '" added.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/home')->with('success', 'Listing "' . $listing->name . '" is updated.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/home')->with('success', 'Listing is deleted.');
    }
